...
namespace Casgem_RapidApi.Controllers
{
    ...
    {
        public async Task<IActionResult> Index(string adult = "1", string child = "1", string checkinDate = "2023-09-27", string checkoutDate = "2023-09-28",
            string roomNumber = "1", string cityID = "-1746443")
        {
